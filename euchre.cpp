...
int main() {
    // Assume pack_filename is a variable containing the specified pack filename from argv
...
//If the winning team had also ordered up, they get 1 point for taking 3 or 4 tricks, and 2 points for taking all 5.
...
//In this project, the number of points needed to win is specified when the program is run.